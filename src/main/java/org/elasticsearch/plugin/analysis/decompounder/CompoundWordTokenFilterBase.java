...
public abstract class CompoundWordTokenFilterBase extends TokenFilter {
    ...
    public final boolean incrementToken() throws IOException {
        if (!tokens.isEmpty()) {
            assert current != null;
            CompoundWordTokenFilterBase.CompoundToken token = tokens.removeFirst();
    ...
    protected class CompoundToken {
        ...
        public CompoundToken(int offset, int length) {
            ...
            this.endOffset = CompoundWordTokenFilterBase.this.offsetAtt.startOffset() + offset + txt.length();
        }
    }
}
